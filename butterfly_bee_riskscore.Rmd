...
### Risk score equation - butterflies
...
### **USER INPUT REQUIRED**: Determine required risk score calculation**  
...
## Calculate $P_t$ 
For butterflies, this is $P_{ta}$ for adults, and $P_{tl}$ for larvae. The same is true for all variables calculated.
