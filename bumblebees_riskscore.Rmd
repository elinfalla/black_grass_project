...
``` {r test-B}
calculate_B(bee, man_strats[6,])[48]
calculate_N_Hn(bee)[48,]
```
...
``` {r test-funcs}
calculate_A_F(bee, bee_plants, plant_locs, man_strats[6,])[48,]
calculate_G_H(bee)[48,]
calculate_Gt(bee, man_strats[6,])[48]
```
