...
EXPLAIN D TIMES F - D is not technically number dietary components as aqueous invertebrates only exist in riparian habitat, so eg. for polecat, by this definition D = 4, but actually D = 3.25, meaning total habitat-diet combo (D times F) = 13, which is the sum of all dietary components across habitats rather than number of dietary components (4) times num habitats (4) = 16 - as this assumes the aqueous inverts are found in all habitats.  
