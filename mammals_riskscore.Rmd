...
mamm_man_strats <- read_xlsx("change.xlsx", sheet="mammals") 
...
out <- data.frame(species = all_species,
                  Nt = calc_mamm_Nt(mammals, mamm_man_strats[1,]))
out
```
...
calc_std_mammal_riskscore <- function(data, strategies) {
...
``` {r test-std-risk}
std_risk <- calc_std_mammal_riskscore(mammals, mamm_man_strats)

std_risk[,-1] == riskscores[,-1] / 4
```
